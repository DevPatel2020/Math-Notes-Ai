...
def analyze_image(img: Image, dict_of_vars: dict):
    ...
    prompt = (
        ...
        f"3. Assigning values to variables like x = 4, y = 5, z = 6, etc.: In this case, assign values to variables and return another key in the dict called {{'assign': True}}, keeping the full assignment statement as 'expr' (e.g., 'x = 5') and the value as 'result' in the original dictionary. RETURN AS A LIST OF DICTS. "
